...
def train_val_loaders(sentences, labels, tokenizer, train_prop = 0.9, batch_size = 32, max_length = 32):
...
def train(model, data, labels, tokenizer, train_prop = 0.9, batch_size = 32, max_length = 64, 
